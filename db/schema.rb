...
ActiveRecord::Schema.define(version: 20141220141909) do
  ...
  create_table "market_events", force: true do |t|
    t.integer  "stock_id"
    t.string   "eventname"
  ...
  create_table "stock_useds", force: true do |t|
    t.integer  "user_id"
    t.integer  "stock_id"
    t.integer  "numofstock"
    t.datetime "created_at"
  ...
  create_table "users", force: true do |t|
    ...
    t.string   "encrypted_password",                             default: "abcdefgh", null: false
    ...
    t.integer  "status"
    t.string   "username"
    t.decimal  "cash",                   precision: 6, scale: 2, default: "10000.00", null: false
  end
